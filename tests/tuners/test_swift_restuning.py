...
from swift import Swift, SwiftModel, push_to_hub
...
class TestSwiftResTuning(unittest.TestCase):
    ...
    def test_swift_restuning_vit(self):
        ...
        print(f"test_swift_restuning_vit result_origin shape: {result_origin.shape}, result_origin sum: {torch.sum(result_origin)}")
        ...
        print(f"test_swift_restuning_vit result_swift_1 shape: {result_swift_1.shape}, result_swift_1 sum: {torch.sum(result_swift_1)}")
        ...
        print(f"test_swift_restuning_vit result_swift_2 shape: {result_swift_2.shape}, result_swift_2 sum: {torch.sum(result_swift_2)}")
